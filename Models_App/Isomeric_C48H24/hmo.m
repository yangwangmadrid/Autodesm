...
%
% Update:
% Oct 30, 2024: Calculate Wiberg bond indices
...
%    hmoSol.WBI:  matrix of Wiberg bond indices with diagonal entries as
%                 valencies deduced from WBIs 
%    hmoSol.WBIa:  matrix of Wiberg bond indices for alpha electrons
%    hmoSol.WBIb:  matrix of Wiberg bond indices for beta electrons
...
for i1 = 1 : N
    for i2 = i1 + 1 : N
        WBIa( i1, i2 ) = 2 * Da(i1,i2) * Da(i2,i1);
        WBIb( i1, i2 ) = 2 * Db(i1,i2) * Db(i2,i1);
        WBI( i1, i2 ) = WBIa( i1, i2 ) + WBIb( i1, i2 );
        WBIa( i2, i1 ) = WBIa( i1, i2 );
        WBIb( i2, i1 ) = WBIb( i1, i2 );
        WBI( i2, i1 ) = WBI( i1, i2 );
    end
end
for i1 = 1 : N
    WBIa( i1, i1 ) = sum( WBIa( i1, : ) );
    WBIb( i1, i1 ) = sum( WBIb( i1, : ) );
    WBI( i1, i1 ) = sum( WBI( i1, : ) );
end
