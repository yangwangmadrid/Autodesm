...
function data = read_data_all()

dir_data = '../../../Datasets/Benzenoids_C6H6_C96H24/';

inp1 = sprintf( '%s/DATA_small.dat', dir_data );
data1 = readData( inp1 );

inp2 = sprintf( '%s/DATA_medium.dat', dir_data );
data2 = readData( inp2 );

inp3 = sprintf( '%s/DATA_larger.dat', dir_data );
data3 = readData( inp3 );

inp4 = sprintf( '%s/DATA_big.dat', dir_data );
data4 = readData( inp4 );

inp5 = sprintf( '%s/DATA_big88.dat', dir_data );
data5 = readData( inp5 );


% Merge data:
data = mergeData( [ data1, data2, data3, data4, data5 ] );
% % Unpack data:
% [ name_arr, plan_arr, EDFT_arr, EHMO_arr, NC_arr, NH_arr, ...
